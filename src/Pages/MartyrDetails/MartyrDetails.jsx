...
const MartyrDetails = () => {
    ...
    return (
        <div className="font-Poppins container mx-auto">
            ...
            {data && (
                <div className="max-w-xs col-span-1 mx-auto rounded-md shadow-md dark:bg-gray-50 dark:text-gray-800">
                    <img 
                        src={data.martyrsImage} 
                        alt={data.martyrsName || 'Martyr image'} // Provide meaningful alt text
            ...
            <div className="  rounded-2xl w-[80%] mx-auto bg-[#E7E7E7] p-5">
                ...
                <p className="dark:text-gray-700 ml-1">{data.details || 'We are seeking more information about {data.martyrsName}. If you have any details or insights, please help us by sharing them.'} </p>
            </div>
